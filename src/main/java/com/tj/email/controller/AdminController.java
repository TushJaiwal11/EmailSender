...
public class AdminController {
	...
	@GetMapping("/users")
	public ResponseEntity<List<UserDto>> getAllUserByNewestUser(@RequestHeader("Authorization") String jwt)
		...
		List<UserDto> allUsers = adminService.getAllUsers(profile);
